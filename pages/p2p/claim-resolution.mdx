...
> **Prototype algorithm.** The production Grid coordinator currently assigns
> jobs. This deterministic sketch assumes an authenticated, consistent worker
> set that the prototype does not yet have; it is not a security or consensus
> guarantee.
