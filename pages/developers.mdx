...
See **[Integrations](/integrations)** for tested Open WebUI and LangChain
configuration plus the publication status of native Dify, ElizaOS, LiteLLM,
Vercel AI SDK, and n8n work.
