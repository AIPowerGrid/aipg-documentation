...
also pull `ghcr.io/aipowergrid/validator:v0.1.0-preview.9`; prereleases do not
publish `latest`.

Preview.9 bundles the bounded image and video decoder dependencies on every
