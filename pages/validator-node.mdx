...
Source and local Docker installs are available now. The command shape mirrors
the worker quickstarts; the stable hosted installer and downloadable binaries
