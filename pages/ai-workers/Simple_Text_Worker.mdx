...
This archived guide describes contributing GPU resources through the retired
Simple Text Worker. Current workers use the payout behavior documented in
[Run a Node](/run-a-node); do not rely on the economics or setup details below.
