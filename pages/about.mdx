...
**Smart contracts on Base** - Model registry, workflow storage, job anchoring, worker bonding, staking rewards. On-chain settlement and registries are live; full on-chain job verification is part of the roadmap as the network decentralizes.
...
- **StakingVault** - Staking contract (rewards program is winding down; withdrawals open)
...
### Run a Worker
- Contribute your GPU and earn USDC + AIPG: [LLM Worker](/worker-llm) or [Media Worker](/worker-media)

### Staking (Wind-Down)
- The staking rewards program is winding down — existing stakers can [withdraw](/staking) anytime
