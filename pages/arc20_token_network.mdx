...
7. **Settlement**: Worker earns USDC + AIPG, your treasury earns revenue share
...
A: Workers receive USDC + AIPG (~50/50 target). The payment router handles conversion from your token.
