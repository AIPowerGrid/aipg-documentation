...
In the coming months we will be transforming blockchain and AI integration with our token standard ARC20, a game changing step forward towards our vision of democratizing #GenAI. ARC20 will be the backbone of an open, decentralized ecosystem where groundbreaking AI applications will be built by developers that share our vision.
