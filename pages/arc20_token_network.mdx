...
The Token Factory concept explores how **developers might launch networks and
tokens on top of AIPG**. It is not a deployable toolkit today. Any implementation
would need an audited payment adapter, reservation path, settlement policy, and
public deployment before a token could use Grid compute.
