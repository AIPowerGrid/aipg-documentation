...
| **Model Registry** | Access a growing set of open models AIPG already serves (FLUX, image, LLMs) |
...
For generation via the API, users can also call the Grid Streaming API directly:
