...
> **Note:** This whitepaper was written during AIPG's original Ravencoin-fork era. The project has since migrated to **Base L2** with a new architecture. The vision and principles remain the same, but the technical implementation has evolved. See [The Grid](/grid-overview) for current architecture.
